...
폴더는 [계정명] - [연도 & 해당 월] - [문제를 푼 날짜] - [문제번호] 로 구성되어 있습니다.
...
> - 데이터중에 문제 내용으로 보면 -1이 출력되어야하는데, 61이 출력되는 경우가 있다. 그래서 데이터 추가 요청을 보내기는 했는데, 수정이 될지 아니면 내가 잘못 본건지는 지켜봐야 알 것 같다. (https://www.acmicpc.net/board/view/110632)